...
import { Upload, FileSpreadsheet, AlertCircle, Loader2, ChevronDown, LogOut, LayoutDashboard, Download, Globe, Briefcase, Mic } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-mesh flex flex-col items-center justify-center p-6">
      <div className="absolute top-4 right-4 flex items-center gap-2">
        <Button variant="ghost" size="sm" onClick={() => navigate('/aida')} className="text-xs text-muted-foreground">
          <Mic className="w-3 h-3 mr-1" /> AIDA
        </Button>
