...
import { ArrowLeft, Trash2, ExternalLink, Loader2, LayoutDashboard, Globe, Lock, FileSpreadsheet, Rows3, Columns3, ShieldCheck } from 'lucide-react';
      ...
      <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground">{dashboards.length} {t('dashboards.count')}</p>
          </div>
          <ThemeToggle />
          <LanguageToggle />
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 space-y-3">
                    ...
                    {/* Mini data preview bar */}
                    {columnInfo && columnInfo.length > 0 && (
                      <MiniBarPreview columnInfo={columnInfo} />
                    )}
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      {rows != null && (
                        <span className="flex items-center gap-1 text-[10px] text-muted-foreground data-font">
                          <Rows3 className="w-3 h-3" /> {rows.toLocaleString()}
                        </span>
                      )}
                      {columns != null && (
                        <span className="flex items-center gap-1 text-[10px] text-muted-foreground data-font">
