...
const translations: Record<Lang, Record<string, string>> = {
  uz: {
    ...
    'sessions.rows': 'qator',
    'sessions.restore': 'Qayta ishlatish',
    'sessions.restoreHint': "Sessiyani qayta yuklash uchun ustiga bosing",
    'sessions.noData': "Bu eski sessiya — ma'lumotlar saqlanmagan. Yangi fayl yuklang.",
    'sessions.howToFix': "Yangi fayl yuklang — yangi sessiyalar avtomatik saqlanadi va qayta ishlatiladi.",
    'sessions.uploadFile': "Faylni yuklash",
    'sessions.restoreError': "Qayta yuklashda xatolik",
  ...
  en: {
    ...
    'sessions.restoreHint': 'Click to restore session',
    'sessions.noData': 'Legacy session — no data saved. Upload a new file.',
    'sessions.howToFix': 'Upload a new file — new sessions will be saved and restorable.',
    'sessions.uploadFile': 'Upload file',
    'sessions.restoreError': 'Restore failed',
  ...
  ru: {
    'app.title.ai': 'AI Smart',
    'app.title.dashboard': 'Dashboard',
    'app.subtitle': 'Превратите таблицы в интеллектуальные аналитические панели — мгновенно.',
    'upload.tabFile': 'Загрузка файла',
    'upload.tabApi': 'API',
    'upload.drop': 'Перетащите файл сюда или нажмите для выбора',
    'upload.formats': 'CSV, XLSX, XLS — до 25 МБ',
    'upload.sheet': 'Лист',
    'upload.analyze': 'Анализировать данные',
    'upload.analyzing': 'Анализ...',
    'upload.error.type': 'Загрузите файл CSV, XLSX или XLS.',
    'upload.error.size': 'Размер файла превышает 25 МБ.',
    ...
    'insights.dataset': 'Набор данных: {rows} строк, {cols} столбцов.',
    ...
    'insights.qualityLow': 'Оценка качества {score}/100 — проверьте данные.',
    'insights.topValue': 'Частое значение в "{col}": "{val}" — {count} раз.',
    'insights.highMissing': '{count} столбц(ов) с >20% пропусков: {cols}.',
    'insights.numRange': '"{col}" от {min} до {max} (средн: {avg}).',
    'insights.outliers': '{total} выбросов в {count} числовом столбце.',
    'insights.dateRange': 'Диапазон дат: с {min} по {max}.',
    'filters.button': 'Фильтры',
    'filters.all': 'Все',
    'filters.clear': 'Очистить',
    'table.search': 'Поиск строк...',
    'table.rows': 'строк',
    'table.page': 'Страница',
    'table.of': '/',
    ...
    'chart.missing': 'Пропуски (%)',
    'chart.noData': 'Нет подходящих столбцов для графика.',
    'chart.boxplot': 'Boxplot — распределение и выбросы',
    ...
    'sessions.rows': 'строк',
    'sessions.restore': 'Восстановить',
    'sessions.restoreHint': 'Нажмите, чтобы восстановить сессию',
    'sessions.noData': 'Старая сессия — данных нет. Загрузите новый файл.',
    'sessions.howToFix': 'Загрузите новый файл — новые сессии сохранятся и будут восстанавливаться.',
    'sessions.uploadFile': 'Загрузить файл',
    'sessions.restoreError': 'Ошибка восстановления',
    'ai.summary': 'ИИ Резюме',
    'ai.generate': 'Создать ИИ резюме',
    'ai.generating': 'Создание...',
    'ai.noSummary': 'Резюме ещё не создано',
    'ai.error': 'Ошибка создания резюме.',
    ...
    'chart.correlation': 'Корреляционная матрица',
    ...
    'auth.signupSubtitle': 'Создать новый аккаунт',
    ...
    'save.name': 'Название панели',
    'save.public': 'Публичная',
    'save.private': 'Приватная',
    'save.saved': 'Сохранено!',
    'save.copyLink': 'Копировать ссылку',
    'save.copied': 'Скопировано!',
    'save.myDashboards': 'Мои панели',
    ...
    'dashboards.title': 'Мои панели',
    'dashboards.empty': 'Сохранённых панелей пока нет',
    'dashboards.open': 'Открыть',
    'dashboards.delete': 'Удалить',
    'dashboards.confirmDelete': 'Вы уверены, что хотите удалить?',
    'dashboards.created': 'Создано',
    'dashboards.count': 'панелей',
    'dashboards.createFirst': 'Создайте первую панель →',
    'agent.title': 'ИИ Аналитик',
    'agent.placeholder': 'Задайте вопрос о ваших данных...',
    'agent.send': 'Отправить',
    'agent.thinking': 'Думаю...',
    'agent.welcome': 'Здравствуйте! Я ваш аналитик данных. Задайте любой вопрос.',
    'code.title': 'Просмотр кода',
    'code.copy': 'Копировать',
    'code.download': 'Скачать',
    'report.title': 'Отчёт о очистке',
    ...
    'report.numericConverted': 'Числа сконвертированы',
    'report.datesParsed': 'Даты обработаны',
